...
#-------------tubo ---------------------------------------------------
s.Line(point1=(116.00, 100.00+iOffSet+iesp), point2=(116.00, 35.74+iOffSet+iesp))
s.Arc3Points(point1=(116.00, 35.74+iOffSet+iesp), point2=(134.50,35.74+iOffSet+iesp), 
    point3=(125.25, 26.49+iOffSet+iesp))
s.Line(point1=(134.50, 35.74+iOffSet+iesp), point2=(134.50, 100.00+iOffSet+iesp))
s.Line(point1=(134.50, 100.00+iOffSet+iesp), point2=(116.00, 100.00+iOffSet+iesp))
#-----------------------------------------------------------------------------
...
p.ReferencePoint(point=(0.0, 29.39+iOffSet, 0.0))
...
#-------------anel real+offset---------------------------------------------------------
s1.Line(point1=(116.00, 30.00), point2=(118.00, 30.0))
s1.Arc3Points(point1=(118.00, 30.00), point2=(132.50, 30.00), 
    point3=(125.25, 24.49))
s1.Line(point1=(132.50, 30.00), point2=(134.50, 30.00))
s1.Line(point1=(134.50, 30.00), point2=(134.50, 12.70))
s1.Line(point1=(134.50, 12.70), point2=(156.50+jOffSet, 12.70))
s1.Line(point1=(156.50+jOffSet, 12.70), point2=(156.50+jOffSet, 0.00))
s1.Line(point1=(156.50+jOffSet, 0.00), point2=(116.00, 0.00))
s1.Line(point1=(116.00, 0.00), point2=(116.00, 30.00))
#---------------------------------------------------------------------------------
...
a = mdb.models['Model-1'].rootAssembly
belowCoordEdgeSet(a,'bottomPipe_weld-1','bottomAttachment',0.0)
highestEdgeSet('topPipe_weld-1','topAttachment')
mostRightEdgeSet('bottomPipe_weld-1','rightAttachment')

a = mdb.models['Model-1'].rootAssembly
f1 = a.instances['bottomPipe_weld-1'].faces
faces1 = f1.getSequenceFromMask(mask=('[#1 ]', ), )
a.Set(faces=faces1, name='bottomFullFace')

a = mdb.models['Model-1'].rootAssembly
f2 = a.instances['topPipe_weld-1'].faces
...
highestSurface('topPipe_weld-1','topPipeHighestSurface')
lowestSurface('bottomPipe_weld-1','bottomPipeLowestSurface')
mostRightSurface('bottomPipe_weld-1','bottomPipeMostRightSurface')
#leftCoordSurface('topPipe_weld-1','topPipeMostLeftSurface',62.77)
#midleSurface('topPipe_weld-1','topPipeMidleSurface',2.0)
...
#mesh controls
a6 = mdb.models['Model-1'].rootAssembly
partInstanceTop =(a6.instances['topPipe_weld-1'], )
partInstanceBot =(a6.instances['bottomPipe_weld-1'], )
...
upperCutPosition = sliceTopInstance('topPipe_weld-1',upperCutPosition,nearWeldMeshSize)
...
#lowerCutPosition = sliceBottomInstance('bottomPipe_weld-1',lowerCutPosition,bottomNearWeldMeshSize)
...
#arcFacePartition('topPipe_weld-1', (arcX-topR2, arcY+iOffSet), (arcX+topR2,arcY+iOffSet), (arcX, arcY+iOffSet-topR2))
#arcFacePartition('topPipe_weld-1', (arcX-topR1, arcY), (arcX+topR1,arcY), (arcX, arcY-topR1))
#arcFacePartition('bottomPipe_weld-1', (arcX-botR1, arcY), (arcX+botR1,arcY), (arcX, arcY-botR1))
#arcFacePartition('bottomPipe_weld-1', (arcX-botR2, arcY), (arcX+botR2,arcY), (arcX, arcY-botR2))

sliceVerticalInstance('bottomPipe_weld-1',rightCutPosition)

#mesh seeds
removeEdgeSeeds('topPipe_weld-1')
removeEdgeSeeds('bottomPipe_weld-1')
seedNearZeroTop('topPipe_weld-1',nearWeldMeshSize,upperCutPosition +0.001)
seedNearZeroLeftTo('bottomPipe_weld-1',nearWeldMeshSize,rightCutPosition+0.001)
#seedNearZeroBottom('bottomPipe_weld-1',bottomNearWeldMeshSize, lowerCutPosition -0.001)
#seedNearZeroTopR('topPipe_weld-1',topNearWeldMeshSizeBig,arcX,arcY+iOffSet,topR2-0.001)
#seedNearZeroTopR('topPipe_weld-1',topNearWeldMeshSizeSmall,arcX,arcY,topR1-0.001)
#seedNearZeroBottomR('bottomPipe_weld-1',bottomNearWeldMeshSizeBig,arcX,arcY,botR1+0.001)
#seedNearZeroBottomR('bottomPipe_weld-1',bottomNearWeldMeshSizeSmall,arcX,arcY,botR2+0.001)
...
#sliceVerticalInstance('topPipe_weld-1',103.19)
#lowestNodeSet('topPipe_weld-1','lowestNode')
...
#mdb.models['Model-1'].keywordBlock.insert(historyBlock, """,,,4.5e5""")
#mdb.models['Model-1'].keywordBlock.insert(historyBlock, """*controls,parameters=field,field=rotation""")
#mdb.models['Model-1'].keywordBlock.insert(historyBlock, """5""")
#mdb.models['Model-1'].keywordBlock.insert(historyBlock, """*CONTROLS, PARAMETERS=LINE SEARCH""")
...
#            firstInc = weldStepTime/10000.0
#            if weldStepTime > 1.0:
#                firstInc = firstIncA
            outputFrequency = round(weldStepTime/5,4)
            nRemesh=nRemesh-1
            timeCount = 0
#            cleanupFile(logFile,primaryJobName,remeshNumber)
#            cleanupFile(logFile,primaryJobName,remeshNumber-1)
        timeRemaining = simulationTime - totalTime
